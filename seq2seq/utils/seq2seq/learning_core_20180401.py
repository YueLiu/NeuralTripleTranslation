...
class Seq2seqCore:
    def __init__(self,
                 ...
                 pretrained_graph_embedding=None,
                 pretrained_graph_embedding_size=100,
        ...
        self.pretrained_graph_embedding = pretrained_graph_embedding.copy()
        self.pretrained_graph_embedding_size = pretrained_graph_embedding_size
        ...
        self.pretrained_decoder_embeddings = tf.placeholder(shape=(self.decoder_vocab_size,
                                                                   self.pretrained_graph_embedding_size),
                                                            dtype=tf.float32, name='pretrained_decoder_embeddings')
        decoder_embeddings = tf.Variable(tf.constant(0.0, shape=(self.decoder_vocab_size,
                                                                 self.pretrained_graph_embedding_size)),
                                         dtype=tf.float32, trainable=False)
        decoder_embeddings.assign(self.pretrained_decoder_embeddings)
    ...
    def fit(self, input_feed_dict):
        ...
        feed_dict[self.pretrained_decoder_embeddings] = self.pretrained_graph_embedding
